...
public class ExException {
    ...
    private static final String CONST_COMMON_TASK_INPUT_NAME = "以下の例外を発生させるためのパラメーター（1〜3）のいずれかを入力"
     ...
     */
    // ここへ記述
    private static void nullPo(String val) throws NullPointerException {
        if (val != null) {
    ...
    private static int checkArray() throws ArrayIndexOutOfBoundsException {
        int list[] = new int[3];
        list[0] = 1;
        list[1] = 2;
        list[2] = 3;
